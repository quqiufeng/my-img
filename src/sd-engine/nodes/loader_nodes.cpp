...
DEFINE_ONNX_PLACEHOLDER_NODE(RemBGModelLoaderNode, "RemBGModelLoader", "loaders",
    rembg_loader_inputs, rembg_loader_outputs, sd_error_t::ERROR_MODEL_LOADING)
REGISTER_NODE("RemBGModelLoader", RemBGModelLoaderNode);
...
DEFINE_ONNX_PLACEHOLDER_NODE(LineArtLoaderNode, "LineArtLoader", "loaders",
    lineart_loader_inputs, lineart_loader_outputs, sd_error_t::ERROR_MODEL_LOADING)
REGISTER_NODE("LineArtLoader", LineArtLoaderNode);
...
DEFINE_ONNX_PLACEHOLDER_NODE(FaceDetectModelLoaderNode, "FaceDetectModelLoader", "loaders",
    face_detect_loader_inputs, face_detect_loader_outputs, sd_error_t::ERROR_MODEL_LOADING)
REGISTER_NODE("FaceDetectModelLoader", FaceDetectModelLoaderNode);
...
DEFINE_ONNX_PLACEHOLDER_NODE(FaceSwapModelLoaderNode, "FaceSwapModelLoader", "loaders",
    face_swap_loader_inputs, face_swap_loader_outputs, sd_error_t::ERROR_MODEL_LOADING)
REGISTER_NODE("FaceSwapModelLoader", FaceSwapModelLoaderNode);
